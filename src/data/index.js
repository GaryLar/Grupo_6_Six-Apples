...
module.exports = {
    getProducts: JSON.parse(fs.readFileSync(path.join(dirname, "/products.json"), "utf-8")), /* busco el json original y lo 'transformo a objeto */
    writeProducts: (data) => {
        fs.writeFileSync(path.join(dirname, "/products.json"), JSON.stringify(data)); /* al json original (q es objeto) le sobrescribo los nuevos datos, y lo paso a formato json */
    },
